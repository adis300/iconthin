...
const encodeDisi = "ACEGIKMOQSUWYBDFHJLNPRTVXZ1357924680acegikmoqsuwybdfhjlnprtvxz$_"
...
// ADEncoding is disi flavor of encoding
var ADEncoding = NewEncoding(encodeDisi).WithPadding(NoPadding)

// var ADEncoding = NewEncoding(encodeURL)
